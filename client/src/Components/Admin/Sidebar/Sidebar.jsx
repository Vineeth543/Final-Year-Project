  ...
  return (
    <>
      <div
        className={` ${
          open ? "w-72" : "w-20 "
        } bg-sky-300 h-screen p-5 pt-8 relative duration-300`}
      >
        <img
          src="https://cdn-icons.flaticon.com/png/512/5611/premium/5611871.png?token=exp=1654178734~hmac=3972eca06e3b392194c8da3689989dd9"
          alt=""
        ...
        <ul className="pt-6">
          {Menus.map((Menu, index) => (
            <Link to={`/admin/${Menu.title.toLowerCase()}`}>
              <li
                key={index}
                className={`flex rounded-md p-2 mt-4 cursor-pointer hover:bg-black hover:text-white text-black text-lg font-semibold items-center gap-x-4 ${
