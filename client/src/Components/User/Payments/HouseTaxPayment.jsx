...
const HouseTaxPayment = () => {
  ...
  const [houseTaxData, setHouseTaxData] = useState(false);
          ...
          <div className="flex items-center justify-evenly bg-gray-200 py-20">
            ...
            >
              ...
              <button
                ...
                disabled={userId && !houseTaxData ? false : true}
              >
                Get Tax
              </button>
            </form>
            <div className="flex w-[30rem] flex-col items-center gap-10 font-semibold text-2xl rounded-3xl">
              {houseTaxData && (
                <>
                  <h1>Your House Tax for This year is:</h1>
                  <h2>Rs. 400</h2>
                  <button
                    onClick={payHomeTax}
...
export default HouseTaxPayment;
