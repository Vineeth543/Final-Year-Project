...
const UserHomePageTenders = () => {
  ...
  return (
    <>
      <div className="flex flex-col bg-sky-200 pt-8 pb-10 rounded mx-44 gap-8 ">
        ...
        {tenderDetails.length > 0 ? (
          tenderDetails.map((tender, index) => (
            <div
              className="flex flex-col w-[85rem] bg-white m-auto hover:shadow-2xl rounded-xl border"
              key={index}
            >
              ...
              <div className="flex flex-col p-4 text-md font-base gap-2 pb-10">
                ...
                {tender.status === "active" ? (
                  ...
                  <h2 className="text-center text-red-500 font-bold text-3xl">
                    Tender closed and winners has been declared for this tender.
                  </h2>
                )}
              </div>
            </div>
...
export default UserHomePageTenders;
